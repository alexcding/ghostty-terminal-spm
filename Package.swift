...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/alexcding/ghostty-terminal-spm/releases/download/1.6.20260909-taskhub.1/GhosttyKit.xcframework.zip",
            checksum: "ea3ca3696b643039a394c0f59820793a6762edbcf99437183f3a9f9890c7ddb7"
        ),
        .testTarget(
            name: "GhosttyKitTest",
