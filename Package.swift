...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/alexcding/ghostty-terminal-spm/releases/download/1.6.20260922-craft.1/GhosttyKit.xcframework.zip",
            checksum: "7838038041b1a8e70329d9761287514a9afe9748f3024a9108f0e5884227aa68"
        ),
        .testTarget(
            name: "GhosttyKitTest",
