...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/alexcding/ghostty-terminal-spm/releases/download/1.6.20260922-cascade.1/GhosttyKit.xcframework.zip",
            checksum: "b760b00348c341e91f4a9fd184a9b5eed201cb9715190922ed7eff55a87c8dd4"
        ),
        .testTarget(
            name: "GhosttyKitTest",
